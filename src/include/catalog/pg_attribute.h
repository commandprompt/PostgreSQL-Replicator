...
/* Note: if you change this, you must update include/catalog/repl_forwarder.h too */
#define Schema_repl_forwarder \
{ 4552, {"name"},	  19, -1, NAMEDATALEN, 1, 0, -1, -1, false, 'p', 'i',  true, false, false, true, 0, { 0 } }, \
{ 4552, {"host"},	 869, -1,		   -1, 2, 0, -1, -1, false, 'm', 'i',  true, false, false, true, 0, { 0 } }, \
{ 4552, {"port"},	  23, -1,		    4, 3, 0, -1, -1,  true, 'p', 'i',  true, false, false, true, 0, { 0 } }, \
{ 4552, {"authkey"},  25, -1,		   -1, 4, 0, -1, -1, false, 'x', 'i', false, false, false, true, 0, { 0 } }, \
{ 4552, {"ssl"},	  16, -1,		    1, 5, 0, -1, -1,  true, 'p', 'c',  true, false, false, true, 0, { 0 } }, \
{ 4552, {"active"},   16, -1,			1, 6, 0, -1, -1, false, 'p', 'c',  true, false, false, true, 0, { 0 } } 
